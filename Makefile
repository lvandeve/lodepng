...
override CXXFLAGS := -MD -W -Wall -Wextra -ansi -pedantic -O3 $(CXXFLAGS)

OBJS = *.o
OBJS += examples/example_sdl.o
DEPS = $(wildcard *.d examples/*.d)
...
clean:
	rm -f unittest benchmark pngdetail showpng $(OBJS) $(DEPS)
